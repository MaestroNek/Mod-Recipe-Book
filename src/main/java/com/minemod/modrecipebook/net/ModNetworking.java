...
public final class ModNetworking {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(BookmarkSyncPayload.TYPE, BookmarkSyncPayload.STREAM_CODEC, BookmarkSyncPayload::handle);
        ...
        registrar.playToServer(BookmarkPayload.TYPE, BookmarkPayload.STREAM_CODEC, BookmarkPayload::handle);
    }
}
